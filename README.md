...
NeoCanvas 是一款面向图片、视频、音频的全能创作工作台。它把画布编排、AI 图片 / 视频 / 音频生成、参考图编辑、对话助手、技能库和素材沉淀放在同一个界面里，适合用来探索视觉方案并连续迭代漫画与视觉结果
...
- AI 创作：支持 OpenAI 兼容接口的 Images API、Responses API、图生图、参考图编辑、流式接收、Base64 图片返回；Seedance 2.0 可通过火山方舟 Ark 按量计费接口接入
...
- 技能库：内置创作技能入口，后续可持续加入分镜、角色、风格、排版等能力
- 提示词与素材：服务器素材库和“我的素材”可在生图、画布 AI 和工作流中复用
