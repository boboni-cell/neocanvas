...
import { AuditOutlined, HomeOutlined, LogoutOutlined, PictureOutlined, SettingOutlined, TransactionOutlined, UserOutlined } from "@ant-design/icons";
        ...
        : pathname.startsWith("/admin/assets")
          ...
          : pathname.startsWith("/admin/ai-logs")
              ...
              : pathname.startsWith("/admin/users")
                ? "/admin/users"
                : "";
    const pageTitle = pathname.startsWith("/admin/settings") ? "系统设置" : pathname.startsWith("/admin/assets") ? "素材库管理" : pathname.startsWith("/admin/ai-logs") ? "AI 日志" : pathname.startsWith("/admin/credit-logs") ? "算力点日志" : "用户管理";
        ...
        <Layout hasSider style={{ height: "100vh", overflow: "hidden", background: antToken.colorBgLayout }}>
            <Layout.Sider width={adminLayoutStyle.siderWidth} style={{ height: "100vh", overflow: "hidden", background: antToken.colorBgContainer, borderRight: `1px solid ${antToken.colorBorder}` }}>
                <Flex align="center" gap={12} style={{ height: adminLayoutStyle.brandHeight, padding: "0 20px", borderBottom: `1px solid ${antToken.colorBorderSecondary}` }}>
                    ...
                    <Typography.Text strong style={{ fontSize: 18, letterSpacing: 0, color: "#00ff66" }}>
                        NeoCanvas
                    </Typography.Text>
                </Flex>
                <Menu
