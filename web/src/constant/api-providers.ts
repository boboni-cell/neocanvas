...
export const API_PROVIDERS: ApiProvider[] = [
    ...
    { id: "ark", label: "火山 Ark", protocol: "openai", baseUrl: "https://ark.cn-beijing.volces.com/api/v3", defaultModel: "doubao-seedream-5-0-pro", description: "火山方舟 Ark 接口，按量计费。", preset: true, capability: "image" },
